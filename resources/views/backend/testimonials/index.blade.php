...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div>
            <h1 class="h3 mb-1 text-gray-800">Testimonials Management</h1>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">
                <i class="fas fa-comment-dots mr-2"></i>Testimonials List
            </h6>
        </div>
        <div class="card-body">
                        ...
                        @forelse ($lists as $list)
                            <tr>
                                ...
                                <td class="align-middle text-center">
                                    @if ($list->image)
                                        <img src="{{ asset('storage/' . $list->image) }}"
                                            ...
                                            alt="{{ $list->name_en ?? 'Testimonial image' }}">
                                    @else
                                ...
                                <td class="align-middle">
                                    <div class="font-weight-bold text-dark">{{ $list->name_en ?? '-' }}</div>
                                    <div class="small text-muted">{{ $list->designation_en ?? '-' }}</div>
                                </td>
                                <td class="align-middle">
                                    <div class="font-weight-bold text-dark">{{ $list->name_ne ?? '-' }}</div>
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content border-0 shadow-lg">
                                                ...
                                                <div class="modal-footer bg-light">
                                                    ...
                                                    <form method="POST" action="{{ route('testimonials.destroy', $list->id) }}">
                                                        @csrf
                                                        @method('DELETE')
