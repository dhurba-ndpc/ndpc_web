...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div>
            <h1 class="h3 mb-1 text-gray-800">Technology Solution Categories</h1>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a href="{{ route('dashboard.index') }}">Dashboard</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Technology Solution Categories</li>
                </ol>
            </nav>
        </div>
        @can('TechnologySolutionCategory-Create')
            <a href="{{ route('technology-solution-categories.create') }}"
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">
                <i class="fas fa-layer-group mr-2"></i>Technology Solution Category List
            </h6>
        </div>
        <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td class="align-middle text-center">
                                    <div class="btn-group" role="group">
                                        @can('TechnologySolutionCategory-Edit')
                                            <a href="{{ route('technology-solution-categories.edit', $list->id) }}"
                                                class="btn btn-info btn-sm shadow-sm"
                                                title="Edit">
                                                <i class="fas fa-pencil-alt"></i>
                                            </a>
                                        @endcan
                                        @can('TechnologySolutionCategory-Delete')
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content border-0 shadow-lg">
                                                ...
                                                <div class="modal-footer bg-light">
                                                    ...
                                                    <form method="POST"
                                                        action="{{ route('technology-solution-categories.destroy', $list->id) }}">
                                                        @csrf
                                                        @method('DELETE')
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="text-center text-muted py-4">
                                    ...
                                    No technology solution categories found.
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
