                    ...
                    <form action="{{ isset($data) ? route('ourProduct.update', $data->id) : route('ourProduct.store') }}"
                                    ...
                                    <div class="card-body text-center">
                                        ...
                                        <div class="custom-file text-left">
                                            <input type="file"
                                                ...
                                                id="image"
                                                accept="image/*"
                                                onchange="previewOurProductImage(event)">
                                            <label class="custom-file-label" for="image">Choose image...</label>
                                            @error('image')
                                                <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                                            @enderror
                                        </div>
                                        <small class="text-muted mt-2 d-block">Recommended image size: 800x600px, JPG, PNG or WebP.</small>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            <div class="custom-control custom-switch custom-control-lg mt-md-4 pt-md-2">
                                                ...
                                                <p class="small text-muted">Toggle to make this product visible on the website.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="form-actions">
                            <button type="submit" class="btn btn-primary btn-icon-split shadow-sm">
                                ...
                                <span class="text">{{ isset($data) ? 'Update Our Product' : 'Save Our Product' }}</span>
                            </button>
                            <a href="{{ route('ourProduct.index') }}" class="btn btn-secondary btn-icon-split shadow-sm ml-2">
                                <span class="icon text-white-50">
