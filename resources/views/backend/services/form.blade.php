...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div>
            <h1 class="h3 mb-1 text-gray-800">{{ isset($data) ? 'Edit Service' : 'Create Service' }}</h1>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a href="{{ route('dashboard.index') }}">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('services.index') }}">Services</a></li>
                    <li class="breadcrumb-item active" aria-current="page">
                        {{ isset($data) ? 'Edit Service' : 'Create Service' }}</li>
                </ol>
            </nav>
        </div>
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3 bg-primary">
                    <h6 class="m-0 font-weight-bold text-white">
                        <i class="fas fa-concierge-bell mr-2"></i>Service Information
                    </h6>
                </div>
                <div class="card-body">
                    <form action="{{ isset($data) ? route('services.update', $data->id) : route('services.store') }}"
                        method="POST">
                        @csrf
                        @if (isset($data))
                            @method('PUT')
                        ...
                        <div class="row">
                                    ...
                                    <div class="card-header bg-light">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <h6 class="m-0 font-weight-bold text-primary">
                                                <i class="fas fa-icons mr-1"></i> Service Icon
                                            </h6>
                                    ...
                                    <div class="card-body">
                                        <div class="rounded bg-light border d-flex align-items-center justify-content-center mb-3"
                                            ...
                                            <div class="bg-white border rounded-circle shadow-sm d-flex align-items-center justify-content-center text-primary"
                                                ...
                                                <i id="serviceIconPreview"
                                                    class="{{ old('bootstrap_icon', $data->bootstrap_icon ?? 'bi bi-gear') }}"
                                        ...
                                        <div class="form-group mb-0">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text"
                                                    ...
                                                    oninput="previewServiceIcon(this.value)">
                            ...
                            <div class="col-lg-8">
                                <ul class="nav nav-tabs nav-fill mb-4" id="serviceLanguageTabs" role="tablist">
                                    <li class="nav-item">
                                ...
                                <div class="tab-content" id="serviceLanguageTabsContent">
                                            ...
                                            <div class="card-body">
                                                <div class="form-group mb-3">
                                                    <label for="title_en" class="form-label">
                                                        <i class="fas fa-heading text-success"></i> Service Title
                                                    </label>
                                                    <input type="text"
                                                        class="form-control @error('title_en') is-invalid @enderror"
                                                        id="title_en" name="title_en"
                                                        value="{{ old('title_en', $data->title_en ?? '') }}"
                                                        placeholder="Enter English service title">
                                                    @error('title_en')
                                                        <div class="invalid-feedback">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            <div class="custom-control custom-switch custom-control-lg mt-md-4 pt-md-2">
                                                ...
                                                <p class="small text-muted">Toggle to make this service visible on the
                                                    website.</p>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="form-actions">
                            <button type="submit" class="btn btn-primary btn-icon-split shadow-sm">
                                ...
                                <span class="text">{{ isset($data) ? 'Update Service' : 'Save Service' }}</span>
                            </button>
...
@push('script')
    <script>
        function previewServiceIcon(iconClass) {
            const preview = document.getElementById('serviceIconPreview');
            preview.className = iconClass || 'bi bi-gear';
        }
    </script>
    <script>
