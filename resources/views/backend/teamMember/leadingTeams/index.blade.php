...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <div>
            <h1 class="h3 mb-1 text-gray-800">Leading Teams</h1>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a href="{{ route('dashboard.index') }}">Dashboard</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Leading Teams</li>
                </ol>
            </nav>
        </div>
        @can('LeadingTeam-Create')
            <a href="{{ route('leadingTeams.create') }}" class="btn btn-primary btn-sm btn-icon-split shadow-sm">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">
                <i class="fas fa-users-cog mr-2"></i>Leading Team List
            </h6>
        </div>
        <div class="card-body">
                ...
                <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        ...
                        @foreach ($lists as $list)
                            @if ($list->type === 'leading_team')
                                @php
                                    $leadingTeamCount++;
                                @endphp

                                <tr>
                                    <td class="align-middle">{{ $leadingTeamCount }}</td>
                                    ...
                                    <td class="align-middle">
                                        ...
                                        <span class="badge badge-light border text-primary mt-1">
                                            <i class="fas fa-users-cog mr-1"></i>Leading Team
                                        </span>
                                    </td>
                                    <td class="align-middle">
                                        <div class="text-dark">{{ $list->designation_en ?? 'N/A' }}</div>
                                        @if (!empty($list->designation_ne))
                                    ...
                                    <td class="align-middle text-center">
                                        <div class="btn-group" role="group">
                                            @can('LeadingTeam-Edit')
                                                <a href="{{ route('leadingTeams.edit', $list->id) }}"
                                                    class="btn btn-info btn-sm shadow-sm"
                                                    title="Edit">
                                                    <i class="fas fa-pencil-alt"></i>
                                                </a>
                                            @endcan
                                            @can('LeadingTeam-Delete')
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content border-0 shadow-lg">
                                                    ...
                                                    <div class="modal-body text-left p-4">
                                                        Are you sure you want to delete leading team member
                                                    ...
                                                    <div class="modal-footer bg-light">
                                                        ...
                                                        <form method="POST" action="{{ route('leadingTeams.destroy', $list->id) }}">
                                                            @csrf
                                                            @method('DELETE')
