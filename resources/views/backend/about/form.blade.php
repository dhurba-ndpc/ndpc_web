        ...
        <div>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{ isset($data) ? 'Edit About' : 'Create About' }}
                    </li>
                </ol>
            </nav>
        </div>
        ...
        <div class="col-lg-12">
            @can('About-Create')
                <div class="card shadow mb-4 ">
                    ...
                    <div class="card-body">
                        <form id="aboutForm"
                            action="{{ isset($data) ? route('about.update', $data->id) : route('about.store') }}" method="POST"
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <ul class="nav nav-tabs nav-fill mb-4 aboutPage_lang_tab" id="languageTabs" role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <button
                                                class="nav-link active {{ $errors->has('title_en') || $errors->has('description_en') || $errors->has('badge_text_en') ? 'text-danger font-weight-bold' : '' }}"
                                        ...
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link" id="nepali-tab" data-bs-toggle="tab"
                                                ...
                                                <div class="card-body">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            id="badge_text_en" name="badge_text_en"
                                                    ...
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <textarea class="form-control @error('description_en') is-invalid @enderror" id="description_en"
                                                            name="description_en" rows="4" placeholder="Enter description">{{ isset($data) ? $data->description_en : old('description_en') }}</textarea>
                                                ...
                                                <div class="card-body">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            id="badge_text_ne" name="badge_text_ne"
                                                    ...
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <textarea class="form-control @error('description_ne') is-invalid @enderror" id="description_ne"
                                                            name="description_ne" rows="4" placeholder="विवरण प्रविष्ट गर्नुहोस्">{{ isset($data) ? $data->description_ne : old('description_ne') }}</textarea>
                            ...
                            <div class="row mt-4">
                                <div class="col-lg-8">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" class="form-control @error('glass_text') is-invalid @enderror"
                                            id="glass_text" name="glass_text"
                                ...
                                <div class="col-lg-4">
                                    @php
                                        $hasPermission =
                                            (!isset($data) && auth()->user()->can('About-Create')) ||
                                            (isset($data) && auth()->user()->can('About-Edit'));
                                    @endphp
                                    ...
                                    <div class="form-group mb-3">
                                        <div class="custom-control custom-switch custom-control-lg">
                                            ...
                                            <p class="small text-muted">
                                                Toggle to make this About visible on the website front-end.
                                            </p>
                            ...
                            <div class="row mt-4">
                                <div class="col-12">
                                    <div class="form-actions">
                                        ...
                                        @if (isset($data))
                                            @can('About-Edit')
                                                <button type="submit" class="btn btn-primary btn-icon-split shadow-sm">
                                                    ...
                                                    <span class="text">Update About</span>
                                                </button>
                                            @else
                                        ...
                                        @else
                                            @can('About-Create')
                                                <button type="submit" class="btn btn-success btn-icon-split shadow-sm">
                                                    ...
                                                    <span class="text">Save About</span>
                                                </button>
                                            @else
                                                <button type="button" class="btn btn-danger btn-icon-split shadow-sm" disabled>
                                                    <span class="icon text-white-50">
                                        ...
                                        <button type="button" id="clearAboutForm"
            ...
            @else
                <div class="card shadow mb-4">
                    <div class="card-body py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Ask Super Admin for more permission.</h6>
                    </div>
                </div>
            @endcan
        </div>
...
@push('script')
    <script>
        $(document).on('click', '#clearAboutForm', function(e) {
            e.preventDefault();
