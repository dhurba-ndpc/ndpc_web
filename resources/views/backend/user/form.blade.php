...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="#" class="btn btn-sm btn-outline-primary shadow-sm">
            <i class="fas fa-list fa-sm mr-1"></i> User List
        </a>
    </div>
                ...
                <div class="d-lg-flex align-items-center justify-content-between">
                    <div class="d-flex align-items-center mb-4 mb-lg-0">
                        ...
                        <div>
                            ...
                            <h2 class="h3 font-weight-bold text-dark mb-1">John Doe</h2>
                            <div class="text-muted mb-3">john.doe@example.com</div>
                    ...
                    <div class="profile-overview-dates">
                        <div class="profile-date-card mb-3">
                            ...
                            <div class="font-weight-bold text-dark">May 07, 2026</div>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6 mb-3">
                        <div class="profile-contact-tile">
                            ...
                            <div class="font-weight-bold text-dark">John Doe</div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 mb-3">
                        <div class="profile-contact-tile">
                            ...
                            <div class="font-weight-bold text-dark text-break">john.doe@example.com</div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 mb-3">
                        <div class="profile-contact-tile">
                            ...
                            <div class="font-weight-bold text-dark">+977 9800000000</div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 mb-3">
                        <div class="profile-contact-tile">
                            ...
                            <div class="font-weight-bold text-dark">Kathmandu, Nepal</div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-8">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" id="phone" name="phone" class="form-control" value="+977 9800000000">
                                </div>
                            </div>

                            <div class="form-group col-md-6">
                                <label for="role" class="small font-weight-bold text-dark">Primary Role</label>
                                <div class="input-group">
                                    <div class="input-group-prepend">
                        ...
                        <div class="form-row mt-3">
                            ...
                            <div class="form-group col-md-6">
                                <label for="password_confirmation" class="small font-weight-bold text-dark">Confirm Password</label>
                                <div class="input-group">
                                    <div class="input-group-prepend">
