    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">
                <i class="fas fa-images mr-2"></i>Gallery List
            </h6>
        </div>
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    <div class="font-weight-bold text-primary">
                                        ...
                                        {{ $list->album->title_en ?? 'N/A' }}
                                    </div>

                                    @if (!empty($list->album?->title_ne))
                                ...
                                <td class="align-middle">
                                    ...
                                    @if (!empty($list->description_en))
                                        <div class="small text-dark">
                                            {!! \Illuminate\Support\Str::limit($list->description_en, 80) !!}
                                        </div>
                                    @endif

                                    @if (!empty($list->description_ne))
                                        <div class="small text-muted mt-1">
                                            {!! \Illuminate\Support\Str::limit($list->description_ne, 80) !!}
                                        </div>
                                    @endif
                                        ...
                                        <div class="modal-dialog modal-dialog-centered"
                                            ...
                                            <div class="modal-content border-0 shadow-lg">
                                                ...
                                                <div class="modal-footer bg-light">
                                                    ...
                                                    <form method="POST"
                                                        action="{{ route('galleries.destroy', $list->id) }}">
