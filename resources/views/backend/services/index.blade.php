...
@section('content')
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        @can('Service-Create')
            <a href="{{ route('services.create') }}" class="btn btn-primary btn-sm btn-icon-split shadow-sm">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">
                <i class="fas fa-concierge-bell mr-2"></i>Service List
            </h6>
        </div>
        <div class="card-body">
                            ...
                            <tr>
                                ...
                                <td class="align-middle text-center">
                                    <div class="bg-light border rounded d-flex align-items-center justify-content-center mx-auto text-primary"
                                        ...
                                        <i class="{{ $list->bootstrap_icon ?: 'bi bi-gear' }}" style="font-size: 32px;"></i>
                                    </div>
                                ...
                                <td class="align-middle text-center">
                                    <div class="btn-group" role="group">
                                        @can('Service-Edit')
                                            <a href="{{ route('services.edit', $list->id) }}"
                                        ...
                                        <div class="modal-dialog modal-dialog-centered" role="document">
                                            <div class="modal-content border-0 shadow-lg">
                                                ...
                                                <div class="modal-footer bg-light">
                                                    ...
                                                    <form method="POST" action="{{ route('services.destroy', $list->id) }}">
                                                        @csrf
                                                        @method('DELETE')
