...
<head>
    ...
    <title>NDPC Dashboard Backend</title>
    ...
    <link rel="stylesheet" href="{{ asset('backend/css/ndpc_backend.css') }}">
...
<body id="page-top">
    ...
    <script src="{{ asset('backend/js/nested-menu2.js') }}"></script>
    ...
    <script type="importmap">
{
    ...
    <script type="module">
        ...
        editorSelectors.forEach(selector => {
            ...
            // Prevent error if textarea does not exist on current page
            if (!element) {
                return;
            }

            // Prevent future duplicate initialization error
