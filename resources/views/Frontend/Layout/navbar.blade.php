            ...
            <ul class="navbar-nav mx-auto gap-1">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item {{ Route::is('notice') ? 'active' : '' }}" href="{{ url('notice') }}">Press Releases</a></li>
                        <li><a class="dropdown-item {{ Route::is('report') ? 'active' : '' }}" href="{{ url('report') }}">Reports</a></li>
                    </ul>
                </li>
                <li class="nav-item"><a class="nav-link {{ Route::is('blogs') ? 'active' : '' }}" href="{{ url('blogs') }}">News/Blogs</a></li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle {{ request()->is('vacancy*') || request()->is('vacancy-result*') ? 'active' : '' }}" href="#" data-bs-toggle="dropdown">Career</a>
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item {{ request()->is('vacancy') ? 'active' : '' }}" href="{{ url('vacancy') }}">Open Positions</a></li>
                        <li><a class="dropdown-item {{ request()->is('vacancy-result') ? 'active' : '' }}" href="{{ url('vacancy-result') }}">Vacancy Results</a></li>
                    </ul>
                </li>
                <li class="nav-item"><a class="nav-link {{ Route::is('contact') ? 'active' : '' }}" href="{{ url('contact') }}">Contact</a></li>
            </ul>
